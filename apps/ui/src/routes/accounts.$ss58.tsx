 ...
 */
/**
 * Registration (NeuronRegistered) footprint over the trailing 30-day window —
 * a KPI summary from /registrations. Like teardown, the section hides itself
 * when the account registered nothing in the window rather than showing an
 * empty card, keeping the page quiet for accounts with no registration activity.
 */
function AccountRegistrationActivitySection({ ss58 }: { ss58: string }) {
  ...
  return (
    <SectionAnchor
      ...
      subtitle="Neuron registrations (NeuronRegistered) for this account over the trailing 30-day window."
      tone="accent"
      info="The account-level companion to subnet registration activity — counts how often this hotkey registered a neuron, and on how many distinct subnets."
    ...
    >
      <div className="grid max-w-2xl gap-4 sm:grid-cols-2">
        ...
        <StatTile
          ...
          hint="subnets with registrations"
          className={KPI_TILE}
        />
      </div>
    </SectionAnchor>
